...
class object_found:
  def __init__(self):
    ...
    self.mapmeta = rospy.Subscriber('/map_metadata', Image, self.image_callback)
  ...
  def image_callback(self, msg):
    ...
    upper_red = numpy.array([100,255,150])
...
rospy.init_node('object_found')
follower = object_found()
rospy.spin()